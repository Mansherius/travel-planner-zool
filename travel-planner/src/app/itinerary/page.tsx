    ...
    <div className="w-full min-h-screen px-4 md:px-12 lg:px-24 flex flex-col lg:flex-row justify-center bg-blue-50">
        ...
        <div className="md:flex md:justify-between py-4">
          ...
          <div className="flex flex-col gap-2 md:flex-row md:flex-wrap lg:gap-2 mt-4 lg:mt-0">
            ...
            >
              ...
              {showMap ? null : <IoMapOutline size={20} className="ml-2" />}
            </button>
          </div>
        </div>
        <Carousel days={days} />
      ...
      >
        <div className="bg-gray-100 flex flex-col p-4 h-full">
          ...
          <div className="py-4 bg-white rounded-full" id="filterBar">
            <div className="flex flex-col items-center md:flex-row md:items-start justify-between px-4">
              <p className="font-bold py-1 md:py-0 md:text-xl hover:text-orange-500 px-2">
                All
              </p>
              <p className="font-bold py-1 md:py-0 md:text-xl hover:text-orange-500 px-2">
                Tourist Attractions
